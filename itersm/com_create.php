...
$theme_community = $_POST['theme_community'];
$id_user = $user_data['iduser'];
$owner_community = $user_data['user_name'];
$type_community = $_POST['type_community'];

if(!empty($name_community) && !empty($theme_community) && !is_numeric($name_community))
    {
        //save to database
        $query = "insert into community (id_user,type_community,theme_community,owner_community,name_community) values ('$id_user','$type_community','$theme_community','$owner_community','$name_community')";
    ...
    <main>
        <div class="container">
            ...
            <div class="middle">
                ...
                <h3 class="form_title">Создание сообщества</h3>
                <br><br>
                <p>
                <input type="text" name="name_community" class="form_input" placeholder="Название сообщества">
                </p>
                <br>
                <p>
                <input type="text" name="theme_community" class="form_input" placeholder="Тематика сообщества">
                </p>
                <br>
                <p>
                    <input class = "form_radio" name="type_community" type="radio" name="radio" value="Закрытое"> Закрытое
                    <br>
                    <input class = "form_radio" name="type_community" type="radio" name="radio" value="Открытое" checked> Открытое
                </p>
                <br>
                <p>
