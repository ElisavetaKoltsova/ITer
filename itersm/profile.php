        ...
        <div class="container">
            ...
            <div class="left">
                ...
                <div class="sidebar">
                    ...
                    <a class="menu-item" href="chat.php" href="chat.php">
            ...
            <div class="middle">
                ...
                <div class="feeds">
                        ...
                        $id = $user_data['iduser'];
                        $sql = "SELECT * from socialmedia.article where id_user = '$id' order by id_article desc";
            ...
            <div class="right">
                <div class="messages">   
                <img src="/pic/profiles_photos/full_img/<?php echo $user_data['avatar']?>" alt="">
                <br>
                ...
                <br><br><br>
                <a class = "btn btn-primary" href="edit_profile.php">Редактировать профиль</a>
                </div> 
            </div>
        </div>
    </main>
